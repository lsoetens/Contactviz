...
knitr::opts_chunk$set(fig.width=7, fig.height=7, fig.path="https://github.com/lsoetens/Contactviz/tree/master/Figs/", cache=FALSE)
options(digits = 4)
```
...
<img src="https://github.com/lsoetens/Contactviz/tree/master/Figs/Disease_specific_settings.png" style="width:650px"/>
