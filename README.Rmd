...
![data](https://github.com/lsoetens/Contactviz/blob/master/Figs/input_tabs.PNG)


The first tab 'data upload'  specifies the data requirements. 


![disease](https://github.com/lsoetens/Contactviz/blob/master/Figs/Disease_specific_settings.PNG)
...
![outbreak](https://github.com/lsoetens/Contactviz/blob/master/Figs/Outbreak_specific_settings.PNG)
...
![plot](https://github.com/lsoetens/Contactviz/blob/master/Figs/Plot_output.PNG)
