...
![plot](https://github.com/lsoetens/Contactviz/blob/master/Figs/input_tabs.PNG)


The first tab 'data upload'  specifies the data requirements. 


![plot](https://github.com/lsoetens/Contactviz/blob/master/Figs/Figs/Disease_specific_settings.PNG)
...
![plot](https://github.com/lsoetens/Contactviz/blob/master/Figs/Figs/Outbreak_specific_settings.PNG)
...
![plot](https://github.com/lsoetens/Contactviz/blob/master/Figs/Figs/Plot_output.PNG)
...
![plot](https://github.com/lsoetens/Contactviz/blob/master/Figs/Figs/Plot_data_table.PNG)
